...
public class GameLoop {
    ...
    public void run(Supplier<GameState> initialStateFactory) {
        try {
            init(initialStateFactory);
            loop();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    private void init(Supplier<GameState> initialStateFactory) {
        ...
        gameStateManager.setState(initialStateFactory.get());
